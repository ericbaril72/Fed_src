...
INT8U MCP_CAN::mcp2515_setCANCTRL_Mode(const INT8U newmode)
{
	...
	//mcp2515_modifyRegister(MCP_CANCTRL,  MODE_LISTENONLY,  MODE_LISTENONLY);
	//MODE_LISTENONLY
	//mcp2515_modifyRegister(MCP_CANCTRL,  MODE_LOOPBACK,  MODE_LOOPBACK);
    //mcp2515_modifyRegister(MCP_CANCTRL, 0x04, 0x04);
